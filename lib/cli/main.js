...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `guldencore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ guldencore-node add wallet-service');
      console.log('    $ guldencore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ guldencore-node remove wallet-service');
      console.log('    $ guldencore-node remove insight-api');
      console.log();
    });
