...
/**
 * Will return the path and default guldencore-node configuration. It will search for the
 * configuration file in the "~/.gulden" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.gulden');
  var defaultConfigFile = path.resolve(defaultPath, './guldencore-node.json');
